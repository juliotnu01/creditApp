                ...
                <div class="bg-white p-2 rounded-lg text-center">
                    ...
                    <div class="pt-6">
                        ...
                        <div class="media flex pb-4">
                            ...
                            <div class="media-body text-xs text-left">
                                ...
                                <div class="mt-2 flex ">
                                    <p class="text-right">Lorem ipsum dolor sit amet, consectetur.</p>
                                </div>
                            </div>
                        </div>
                        <!-- End comments row -->
                        ...
                        <div class="media flex pb-4">
                            ...
                            <div class="media-body text-xs text-left">
                                ...
                                <div class="mt-2 flex ">
                                    <p class="text-right">
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt et at fuga commodi
                                        quis ut. Maiores, architecto. Iure, officia. Earum quae vel quod adipisci nisi
                                        veritatis repudiandae saepe exercitationem similique.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- <div class="mt-5 flex flex-col justify-center mx-auto mb-5">
