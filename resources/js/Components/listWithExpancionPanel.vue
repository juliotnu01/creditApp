...
<template>
    <!-- <li>
        <div class="flex items-center justify-between py-4">
            <h3 class="text-lg font-medium text-gray-900" @click="isExpanded = !isExpanded">{{ title }}</h3>
        </div>
        <div v-show="isExpanded" class="px-4 py-2 text-sm text-gray-500">
            <slot></slot>
        </div>
    </li> -->
    <div class="min-w-2xl mx-auto bg-white p-16 rounded">
