    ...
    <div>
        ...
        <div class=" min-h-auto ">
            ...
            <div class="flex h-auto">
                ...
                <aside v-show="route().current('crear.creditos.*')" class="border-r px-6">
                    <div>
                        <ul class="space-y-2 tracking-wide mt-8">
                            ...
                            <li>
                                <NavLink :href="route('crear.creditos.obligaciones')"
                                    :active="route().current('crear.creditos.obligaciones')"
                                    class=" w-full px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group"
                                    :class="{ 'rounded-xl text-white bg-gradient-to-r from-sky-600 to-cyan-400': route().current('crear.creditos.obligaciones') }">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                                        fill="currentColor">
                                        <path class="fill-current text-gray-300 group-hover:text-cyan-300"
                                            fill-rule="evenodd"
                                    ...
                                    <span class="group-hover:text-gray-700">Obligaciones</span>
                                </NavLink>
                            </li>
                            <li>
                                <a href="#" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                                    ...
                                    <span class="group-hover:text-gray-700">Compromisos</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                ...
                <div class="flex-1 relative text-xs p-8 bg-gray-50 min-h-screen ">
                    <main>
